      ...
      >
        ...
        <View style={{ height: 588, position: 'relative' }}>
          ...
          {GAMES.map((game, index) => (
            ...
            >
              ...
              >
                ...
                <View>
                  <Text style={{ color: ivory, fontFamily: 'PatrickHand', fontSize: 20, lineHeight: 21 }}>{game.name}</Text>
          ...
          <View style={{ position: 'absolute', left: 0, right: 0, top: 548, alignItems: 'center' }} pointerEvents="none">
            <Text style={{ color: '#6a6478', fontSize: 13, fontFamily: 'PatrickHand', letterSpacing: 0.5 }}>tap a game to join</Text>
          </View>
        </View>
      </ScrollView>
    </View>
