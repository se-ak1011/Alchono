...
/** An orbit-style chip that IS the link. PatrickHand pill + plum dot; a
...
function Chip({ r, arrow, onPress }: { r: Resource; arrow?: boolean; onPress: () => void }) {
  return (
    ...
    >
      ...
      <Text style={{ fontFamily: 'PatrickHand', fontSize: 20, lineHeight: 24, color: '#ECE9F1' }} numberOfLines={1}>
